...
Wire::Wire(QPointF p1, QPointF p2, qreal w) : QGraphicsLineItem(QLineF(p1, p2)) {
...
Wire::Wire(qreal x1, qreal y1, qreal x2, qreal y2, qreal w) : QGraphicsLineItem(x1, y1, x2, y2) {
...
QVariant Wire::itemChange(GraphicsItemChange change, QVariant &value) {
